...
bool BlockNode::isEqual(const BlockNode &other) const {
  return statements == other.statements;
}

bool RootNode::isEqual(const RootNode &other) const {
...
bool VarExprNode::isEqual(const VarExprNode &other) const {
  return name == other.name;
}

bool FnCallExprNode::isEqual(const FnCallExprNode &other) const {
